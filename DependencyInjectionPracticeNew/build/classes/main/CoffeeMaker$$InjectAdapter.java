...
public final class CoffeeMaker$$InjectAdapter extends Binding<CoffeeMaker>
  ...
  public CoffeeMaker$$InjectAdapter() {
    super("CoffeeMaker", "members/CoffeeMaker", NOT_SINGLETON, CoffeeMaker.class);
  }
  ...
  public void attach(Linker linker) {
    heater = (Binding<dagger.Lazy<Heater>>) linker.requestBinding("dagger.Lazy<Heater>", CoffeeMaker.class, getClass().getClassLoader());
    pump = (Binding<Pump>) linker.requestBinding("Pump", CoffeeMaker.class, getClass().getClassLoader());
  }
