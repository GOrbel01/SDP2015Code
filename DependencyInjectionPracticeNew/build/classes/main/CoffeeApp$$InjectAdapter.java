...
/**
 * A {@code Binding<CoffeeApp>} implementation which satisfies
...
public final class CoffeeApp$$InjectAdapter extends Binding<CoffeeApp>
  ...
  public CoffeeApp$$InjectAdapter() {
    super("CoffeeApp", "members/CoffeeApp", NOT_SINGLETON, CoffeeApp.class);
  }
  ...
  public void attach(Linker linker) {
    coffeeMaker = (Binding<CoffeeMaker>) linker.requestBinding("CoffeeMaker", CoffeeApp.class, getClass().getClassLoader());
  }
